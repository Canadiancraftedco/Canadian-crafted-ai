...
async function extractProducts(searchResults, category) {
...
export async function GET(request) {
  ...
  try {
    const searchResults = await tavilySearch(`Canadian ${category} brands products made in Canada`);
    ...
    return NextResponse.json({ ok: true, category, searchResultCount: searchResults.length, found: found.length, inserted });
  } catch (err) {
